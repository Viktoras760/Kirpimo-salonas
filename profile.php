            ...
            <div class="card align-items-center" style="border-radius: 1rem; margin: auto;">
                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input readonly type="email" name="email" placeholder = "Įveskite savo elektroninį paštą"  class="form-control form-control-lg " <?php $email = $row['Email']; ?> value="<?php echo $row['Email']; ?>">
                  </div>
