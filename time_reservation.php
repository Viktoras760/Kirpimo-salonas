                    ...
                    <div class="col col-xl-10">
                        <div class="card" style="border-radius: 1rem;">
                            <div class="row g-0">
                                ...
                                <p styles="font-size: 2rem; font-weight: 500; line-height: 1.2;"> Jūsų kirpėjas: Antanas</p>
                                <div class="Dropdown-module_item__2khXS" aria-selected="false"><div class=""><div class="Inline-module_inline__1aHBb Inline-module_md__1Qz4k Inline-module_alignCenter__uIC18 Inline-module_justifyStart__2svO3"><div class="MediaObject-module_mediaItem__1pFSb"><svg height="24" width="24" viewBox="0 0 24 24" class="EmployeeSelect-module_avatar_f8203f" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet" fill="currentColor"><path d="M17.6 13.714A9.987 9.987 0 0122 22h-2a8 8 0 00-4.124-7 8.026 8.026 0 001.724-1.286zM12 2a6 6 0 01.225 11.996L12 14a8 8 0 00-8 8H2c0-4.21 2.603-7.814 6.287-9.288A6 6 0 0112 2zm0 2C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z" fill-rule="evenodd"></path></svg></div><p class="Text-module_caption__1s14T EmployeeSelect-module_text_edc165">Bet kuris specialistas</p></div></div></div>
