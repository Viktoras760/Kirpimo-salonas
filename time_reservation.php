                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-6 d-none d-md-block">
                                    ...
                                    <ul class="responsive-table">
                                        ...
                                        <li class="table-row" style="border-radius: 3px;padding: 25px 30px;display: flex;justify-content: space-between;margin-bottom: 25px; background-color: #ffffff;box-shadow: 0px 0px 9px 0px rgba(0,0,0,0.1);">
                                            <div class="col col-6" data-label="Job Id">Paslaugos teikimo trukmė</div>
                                            <div class="col col-6" data-label="Customer Name" style="text-align: right;"><?php echo $_SESSION['duration']; ?> minučių</div>
                                        </li>
                                        <li class="table-row" style="border-radius: 3px;padding: 25px 30px;display: flex;justify-content: space-between;margin-bottom: 25px; background-color: #ffffff;box-shadow: 0px 0px 9px 0px rgba(0,0,0,0.1);">
                                            <div class="col col-6" data-label="Job Id">Užsakymo suma</div>
